...
export default function Tabs({
  ...
  return (
    <div className="relative flex space-x-6 pb-2 max-w-[25rem]  ">
      <div
        className={`absolute bottom-2 left-0 w-1/2 h-[2px] bg-custom-red-400 transition-transform duration-500 ease-in-out ${indicatorStyle}`}
      ></div>
